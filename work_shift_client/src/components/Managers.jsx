...
export function Managers(props) {
    ...
    return (
        <div className="h-screen w-screen flex">
            <div className="w-full h-fit min-h-full flex justify-center bg-cover bg-fixed bg-center" style={{backgroundImage: `url(${managerPic})`}}>
                <div className="w-full bg-gray-600 bg-opacity-50 flex justify-center">
                    <div className="sm:w-3/4 mt-32 mb-10 flex">
                        <div className="grow">
