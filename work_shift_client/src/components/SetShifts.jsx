...
export function SetShifts(props) {
    ...
    return (
        <div className="w-full h-full bg-cover bg-center flex justify-center" style={{backgroundImage: `url(${timing})`}}>
            <div className="absolute top-32 w-3/4 flex flex-col items-center bg-blue-100 bg-opacity-70 rounded-xl p-3">
