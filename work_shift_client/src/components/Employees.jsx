...
export function Employees(props) {
    ...
    return (
        <div className="w-full h-full flex justify-center bg-cover bg-center" style={{backgroundImage: `url(${employeePic})`}}>
            <div className="w-full h-full bg-gray-600 bg-opacity-50 flex justify-center">
                <div className="sm:w-3/4 absolute top-20 flex justify-center">
                    <div className="grow">
